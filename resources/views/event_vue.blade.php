...
<h2>{{$event->title}}</h2>
    ...
    <a href="../tableaudebord"><button class="return_tolist clickable">Retour à la liste</button></a>
        <span>Nombre de participant inscrit 0/10</span>
        <a href="inscription_event"><button class="clickable">Inscription</button></a>    
    </section>
