...
<div class="cuisinecontent">
    ...
    <div class="cuisine_atelier lesateliers">
        <h3>LES ATELIERS DU DEFI EN LIEN AVEC LA CUISINE </h3>
        <ul>
            <li>Un atelier pour apprendre à fabriquer 
                ses sacs à vrac et ses éponges maison.
            </li>
            <li>
                Un atelier pour réaliser des conserves grâce à la technique de 
                lactofermentation et des boissons à base de kéfir.
            </li>
            <li>
                Un atelier « composter, le B.A. BA » pour fabriquer 
                son composteur et recevoir des conseils d'utilisation.
            </li>
        </ul>
    </div>
    ...
    <p>
        ...
        <strong>« refuser »</strong> et pour cause : c'est celui 
        qui permet de réduire le plus rapidement ses déchets. 
        Par exemple, à la boulangerie, les baguettes sont désormais 
        systématiquement données dans un sac en papier : n'hésitez pas à préciser 
        que vous n'en voulez pas. Si vous souhaitez les transporter emballées, 
        un sac type « tote bag » est tout aussi pratique. Il permet aussi 
        de transporter des viennoiseries...
    </p>
    <p>
    ...
    <section class="faireSescourses">
        ...
        Choisir des <strong>produits de saison</strong>, 
                ...
                (car moins transportés) et plus goûteux. En plus, ça favorise 
        ...
        <ul>
            ...
            <li>un grand sac type cabas
            </li>
            <li>boîtes (en verre de préférence) hermétiques pour les produits à la découpe 
            </li>
    ...
    <div class="remplacer">
        ...
        <img src="images/remplacer_eponges.png" alt="">
        <p>
        … les <strong>éponges</strong> (à la durée de vie courte et non recyclables)...
        </p>
        </div>
        
        <div class="remplacer_tawashi">
            <img src="images/remplacer_tawashi.png" alt="">
        <p>… par un <strong>« tawashi »</strong> : c'est une éponge japonaise 
            faite de tissus récupérés. Pratique pour nettoyer la table par exemple.
        </p> 
        <p>
            En attendant l'atelier, voici un <a target="blank" href="https://www.aufeminin.com/deco-pro/eponge-tawashi-s4009554.html">tuto</a> permettant de le faire avec des pinces à linge 
            et <a target="blank" href="https://www.sowhat-magazine.fr/diy-fabriquer-un-tawashi-chaussette/">un autre</a> avec du carton ou une planche de bois et des clous
        </p>
        </div>
        <div class="remplacer_brosse">
            <img src="images/remplacer_brosse.png" alt="">
            <p>
            … par une <strong>brosse de lavage</strong> pour la vaisselle.
            </p>
        </div>
    </div>
    <section class="bee">
    ...
    <section class="dosette flexrow">
        <div class="dosette_content">
            ...
            adoptant une cafetière à piston, une bonne vieille cafetière 
            filtre avec un filtre permanent…
            </p>
            <p>1 milliard de dosettes sont utilisées en France chaque année = 
                9 milliards dans le monde, soit environ 40.000 tonnes de déchets aluminium.  
            </p>
        </div>
    ...
    <section class="produit_remplacer">
        <div class="content_produit_remplacer flexrow">
            ...
            <div class="produit_replacer_txt">
                <p>
                        … les produits préparés sous emballage par du <strong>« fait maison »</strong> : pâte à pizza, 
                    riz au lait, sauce tomate... beaucoup de recettes sont faciles à faire soi-même. 
                    Ça demande plus de temps, mais c'est une garantie de qualité ! Vous pouvez faire 
    ...
    <p>Les épluchures sont trop souvent jetées à la poubelle. Au mieux, elles sont 
        ...
        pelures, mais aussi peaux, écorces, trognons, pépins, noyaux, côtes, tiges, 
        cosses, fanes, etc. Souvent peu caloriques et intéressants d’un point de vue 
        nutritionnel, ils se cuisinent à toutes les sauces et sont délicieux !
    </p>
    <p class="lesrestes_link"> 
        <a href="https://www.serenity-therapy.fr/zero-dechet-cuisiner-epluchures/">
    www.serenity-therapy.fr
        </a> 
    et 
        <a href="https://www.foodette.fr/blog/anti-gaspi/6-recettes-pour-cuisiner-vos-fanes-de-legumes/">
       foodette.fr
        </a>
    </p>
    </section>
    ...
    <div class="encart connaissezvous">
        <p>
            Vous connaissez des trucs et astuces qui ne sont pas sur cette page ? N’hésitez pas à les partager et/ou envoyez-nous un mail à <a href="mailto:contact@osezzerodechet.bzh">contact@osezzerodechet.bzh</a>
        </p>
    </div>  
</div>
</main>
