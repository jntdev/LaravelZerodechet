    ...
    ?>
        ...
        <div class="genially"style="width: 100%;">
            <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                <iframe frameborder="0" width="1280" height="720" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60e594713bc6cc0dbef1a37b" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                </iframe> 
            </div> 
        </div>
        <div class="list5r style5r">
            <div class="bluegrad1 flexrow alignitems">
                <img class="icon_produits" src="../img/refuser.png" alt="">
            ...
            <div class="bluegrad1 flexrow alignitems">
            <img class="icon_produits" src="../img/reduire.png" alt="">
            ...
            <div class="bluegrad1 flexrow alignitems">
            <img class="icon_produits" src="../img/reutiliser.png" alt="">
                <p><span>Réutiliser</span> en prêtant, réparant, troquant, en pratiquant l'upcycling... et en privilégiant le durable au jetable.
                </p>
            </div>
            <div class="bluegrad1 flexrow alignitems">
            <img class="icon_produits" src="../img/recycler.png" alt="">
                <p><span>Recycler</span> les déchets tout de même produits.
                </p>
                
            </div>
            <div class="bluegrad1 flexrow alignitems">
            <img class="icon_produits" src="../img/composter.png" alt="">
        ...
        <p>Vous trouverez <a href="https://colibris-universite.org/mooc-zerodechet/?Ii62RecapitulonsParTypeDeDechets&course=MoocZeroDechet&module=Ii6Recycler">ici</a> une infographie qui présente le recyclage des 
