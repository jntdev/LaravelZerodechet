...
?>
    <div class="astucontent">
        ...
        <div class="astusection primebackground " onclick="location.href='rappelzerodechet.php';">
            <div class="astuces cinqr clickable"></div>
        </div>
        <div class="astusection secondbackground " onclick="location.href='cartecommercants.php';">
        ...
        <div class="astusection thirdbackground " onclick="location.href='ressources.php';">
        ...
        <div class="astusection fourthbackground " onclick="location.href='produitsmenagers.php';">
        ...
        <div class="astusection fifthbackground " onclick="location.href='biblio.php';">
